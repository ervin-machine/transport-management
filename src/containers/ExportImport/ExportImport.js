...
function createData(name, calories, fat, carbs, protein, mistovar, cijena) {
  return {
    name,
    calories,
    fat,
...
const rows = [
  createData('Export', "Bingo", "11/11/2022", "Tuzla", "22/11/2022", "Srebrenik", 120),
];
...
export default function ExportImport() {
  ...
  return (
    <Box sx={{ width: '80%', backgroundColor: "black" }} display="flex"
    justifyContent="center" >
      <Paper sx={{ width: '80%', mb: 2, backgroundColor: "black" }}>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center" sx={{ color: "white"}}>{row.mistovar}</TableCell>
                      <TableCell align="center" sx={{ color: "white"}}>{row.cijena}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
